...
def get_country_info(country):
    ...
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0","Accept-Language": "en-US,en;q=0.9",
              }#用于把爬虫伪装为浏览器
...
if __name__ == "__main__":
    ...
    country_name = input("Enter the Country Name: ")  # 可以改成 China, Japan 等
    ...
    print("Introduction:", info["Introduction"])'''

'''import requests
from bs4 import BeautifulSoup
import re
from flask import Flask, jsonify   # 新增：用于做网站API

app = Flask(__name__)   # 新增：创建Flask网站

def get_country_info(country):

    country = country.strip().replace(" ", "_")  
    # 新增：处理 South Korea 这种带空格国家
